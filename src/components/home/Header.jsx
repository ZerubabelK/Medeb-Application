    ...
    <View>
      <View className="mx-5">
        ...
        <View className="mt-3">
          ...
          <Text className="text-3xl text-neutral-800">
            {user.firstname} {user.lastname}
          </Text>
        </View>
        <View className="bg-[#1b0f28c8] px-5 rounded-2xl py-4">
          <Text className="text-white text-lg text-center">
            Medeb task managing app
          </Text>
          <View className="flex-row mt-2 justify-center">
            <View className="w-2/3">
              ...
              <TouchableOpacity
                onPress={_ => setActiveTap('Tasks')}
                className="bg-white  py-2 px-2 rounded-2xl mt-3">
